...
public sealed class MicrosoftAgentFrameworkSolutionDesignerAgent : ISolutionDesignerAgent
{
    ...
    public MicrosoftAgentFrameworkSolutionDesignerAgent(string endpoint, string model, IWorkflowRunLogStore logs, IWorkflowPayloadStore payloadStore, int maxModelResponseSeconds)
    {
